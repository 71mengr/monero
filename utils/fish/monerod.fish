...
complete -c monerod -l p2p-bind-port -r -d "Port for p2p network protocol (IPv4). Default: 33339, 33330 if 'testnet', 38081 if 'stagenet'"
complete -c monerod -l p2p-bind-port-ipv6 -d "Port for p2p network protocol (IPv6). Default: 33339, 33330 if 'testnet', 38081 if 'stagenet'"
